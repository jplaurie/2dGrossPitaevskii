...
const bool FLAG_HYPO_DISSIPATION = false;

//friction coefficient
const double alpha = 0.e2;

//negative power of the laplacian (friction = 0)                              
const int alphapower = 0;

//turns on a hypoviscosity cutoff
const bool FLAG_HYPO_CUTOFF = false;    

//value of cutoff the hypoviscosity (wavenumber)
const double alphacutoff = 8.0;          
...
*/
const std::string FLAG_FORCING_TYPE = "off"; //Flag to turn on additive forcing
...
//forcing amplitude 
const double force_amplitude = 2.5e-2;//0.001;   
//forcing wavenumber
const double kf = 32;
